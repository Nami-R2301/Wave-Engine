...
//    [[nodiscard]] static Engine *get_app();
    ...
    [[nodiscard]] float get_engine_framerate() const;
    [[nodiscard]] bool get_running_state() const;
    [[nodiscard]] uint32_t get_exit_status() const;
    
    void set_engine_framerate(float window_framerate);
    ...
    virtual bool any_key_input_callback(On_any_key_callback &key_event);
    ...
    virtual bool any_mouse_input_callback(On_any_mouse_event &mouse_button_event);
