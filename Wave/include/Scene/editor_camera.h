...
namespace Wave
{
  ...
  class Editor_camera : public Perspective_camera
  {
    ...
    void set_focal_point(const Math::Vector_3f &focal_point_);
    ...
    [[nodiscard]] Math::Vector_3f get_focal_point() const;
    [[nodiscard]] Math::Matrix_4f get_view_projection() const;
    ...
    [[nodiscard]] Math::Vector_3f calculate_position() const;
    
    [[nodiscard]] Math::Vector_2f pan_speed() const;
    [[nodiscard]] static float rotation_speed();
    [[nodiscard]] float zoom_speed() const;
    private:
    Math::Vector_3f focal_point = {0.0f, 0.0f, 5.0f};
    Math::Vector_2f initial_mouse_position = {0.0f, 0.0f};
    float distance = 5.0f;
